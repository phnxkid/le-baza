...
if (isset($_POST['submit'])) {
    ...
    if (!empty($email = $_POST['email']) and !empty($_POST['mdp1']) and !empty($_POST['mdp2'])) {
        ...
        if ($_POST['mdp1'] == $_POST['mdp2']) {
            ...
            $req->closeCursor();
            $notif = "<p>Inscription éffectuée avec succès</p>";
        } else {
            # code...
...
<body>
            ...
            <div class="col-lg-4 col-6 text-left">
                <form method="GET" action="recherche.php?search=<?php $_GET['search'] ?>">
                    <div class="input-group">
                        <input type="text" class="form-control" name="search" placeholder="Rechercher des articles">
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div>Si vous avez déjà un compte <a href="connexion.php">cliquez-ici.</a></div><br>
