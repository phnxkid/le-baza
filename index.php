...
<body>
                ...
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <button class="dropdown-item" type="button"> <a href="con_Dec.php">Connexion / Déconnexion</a></button>
            ...
            <div class="col-lg-4 col-6 text-left">
                <form method="GET" action="recherche.php?search=<?php $_GET['search'] ?>">
                    <div class="input-group">
                        <input type="text" class="form-control" name="search" placeholder="Rechercher un Produit" autocomplete="on">
            ...
            <div class="col-lg-8">
                <div id="header-carousel" class="carousel slide carousel-fade mb-30 mb-lg-0" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="carousel-item position-relative" style="height: 430px;">
                            <img class="position-absolute w-100 h-100" src="img/img.jpg" style="object-fit: cover;">
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    <h1 class="display-4 text-white mb-3 animate__animated animate__fadeInDown">Electromenager</h1>
                                    <p class="mx-md-5 px-5 animate__animated animate__bounceIn">Lorem rebum magna amet lorem magna erat diam stet. Sadips duo stet amet amet ndiam elitr ipsum diam</p>
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="#">Acheter</a>
                                </div>
                            </div>
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
                    ...
                    <h5 class="font-weight-semi-bold m-0">14-Jours garantie</h5>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="d-flex align-items-center bg-light mb-4" style="padding: 30px;">
        ...
        <div class="row px-xl-5 pb-3">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="img/iphone1.jpg" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Tablettes & Téléphones</h6>
                            <small class="text-body">100 Products</small>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="img/ordi.jpg" alt="">
                        </div>
                        <div class="flex-fill pl-3">
                            <h6>Informatique</h6>
                            <small class="text-body">100 Products</small>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <a class="text-decoration-none" href="">
                    <div class="cat-item img-zoom d-flex align-items-center mb-4">
                        <div class="overflow-hidden" style="width: 100px; height: 100px;">
                            <img class="img-fluid" src="img/electrom.jpg" alt="">
                        </div>
                        <div class="flex-fill pl-3">
    ...
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Nouvel Arrivage</span></h2>
        <div class="row px-xl-5">
            <?php
            $req = $con->queryAll("SELECT * FROM products ORDER BY product_id DESC");
            # code...
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-6 pb-1">
                    <div class="product-item bg-light mb-4 scrolling-wrapper">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="product_images/<?= $produit['product_img1'] ?>" alt="">
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href="panier/ajouter_panier.php?id=<?= $produit['product_id'] ?>"><i class="fa fa-shopping-cart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href="detail.php?id=<?= $produit['product_id'] ?>"><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="detail.php?id=<?= $produit['product_id'] ?>"><?= substr($produit['product_title'], 0, 16) ?></a>
        ...
        <div class="row px-xl-5">
            <div class="col-md-6">
                <div class="product-offer mb-30" style="height: 300px;">
                    <img class="img-fluid" src="img/offer-1.jpg" alt="">
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">jusqu'à 30% de réduction</h6>
            ...
            <div class="col-md-6">
                <div class="product-offer mb-30" style="height: 300px;">
                    <img class="img-fluid" src="img/offer-2.jpg" alt="">
                    <div class="offer-text">
                        <h6 class="text-white text-uppercase">20% de réduction</h6>
                        <h3 class="text-white mb-3">Offre Speciale</h3>
                        <a href="" class="btn btn-primary">Acheter</a>
                    </div>
                </div>
    ...
    <!-- Products Start -->
    <div class="container-fluid pt-5 pb-3">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">Meilleures ventes</span></h2>
        <div class="row px-xl-5">
            <?php
            include_once('config/connexion.php');
            $req = $con->query("SELECT * FROM products WHERE date='2022-08-08' ORDER BY product_id DESC");
            #while ($row = mysqli_result($req)) {
            # code...
            foreach ($req as $products) :
            ?>
                <div class="col-lg-3 col-md-4 col-sm-6 col-6 pb-1">
                    <div class="product-item bg-light mb-4 scrolling-wrapper">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="product_images/<?= $products['product_img1'] ?>" alt="">
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href="panier/ajouter_panier.php?id=<?= $products['product_id'] ?>"><i class="fa fa-shopping-cart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-search"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href=""><?= substr($products['product_title'], 0, 16) ?></a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
